...
cmake_build_dir = os.getenv("CMAKE_BUILD_DIR", "../cmake-build-debug")

# Doxygen
print("Calling cmake.")
subprocess.call(f'cmake --build {cmake_build_dir} --target doxygen-docs', shell=True)

# -- Project information -----------------------------------------------------

project = 'PER'
copyright = '2021, Michael Aichmüller'
author = 'Michael Aichmüller'
...
release = find_ver(os.path.join("..", "CHANGELOG.md"))
