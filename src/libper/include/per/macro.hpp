...
#	define override
#	define final
#	warning "Keyword override and final are not defined by your compiler. This may lead to wrong result when using PER_API. Please change your compiler to a supported compiler!"
#endif
